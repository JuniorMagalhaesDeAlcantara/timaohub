...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="space-y-10">
            ...
            {{-- CLASSIFICAÇÃO --}}
            @if(isset($standing))
            <div class="bg-gradient-to-br from-black via-gray-900 to-black border-yellow-500 rounded-3xl shadow-xl p-8 border-2 border-blue-800">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div class="bg-white/20 backdrop-blur rounded-2xl p-5">
                        <p class="text-gray-300 text-xs font-bold uppercase">Posição</p>
                        <p class="text-5xl font-black text-white mt-2">{{ $standing['rank'] }}º</p>
                    </div>
                    <div class="bg-white/20 backdrop-blur rounded-2xl p-5">
                        <p class="text-gray-300 text-xs font-bold uppercase">Pontos</p>
                        <p class="text-5xl font-black text-white mt-2">{{ $standing['points'] }}</p>
                    </div>
                    <div class="bg-white/20 backdrop-blur rounded-2xl p-5">
                        <p class="text-gray-300 text-xs font-bold uppercase">Saldo</p>
                        <p class="text-5xl font-black text-white mt-2">{{ $standing['goalsDiff'] > 0 ? '+' : '' }}{{ $standing['goalsDiff'] }}</p>
                    </div>
                    <div class="bg-white/20 backdrop-blur rounded-2xl p-5">
                        <p class="text-gray-300 text-xs font-bold uppercase">Aproveitamento</p>
            ...
            <div class="bg-white rounded-3xl shadow-xl p-8 border-2 border-gray-200">
                ...
                <div class="flex gap-4 justify-center flex-wrap">
                    ...
                    @php
                    $colors = [
                    'W' => 'bg-black text-yellow-400',
                    'D' => 'bg-gray-700 text-white',
                    'L' => 'bg-gray-400 text-black'
                    ];
                    $labels = [
                    'W' => 'V',
                    'D' => 'E',
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                ...
                <div class="bg-gradient-to-br from-black to-gray-900 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition">
                    <p class="text-gray-300 text-sm font-medium">JOGOS</p>
 ...
 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition">
                ...
                <div class="bg-gradient-to-br from-gray-600 to-gray-700 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition">
                ...
                <div class="bg-gradient-to-br from-gray-800 to-black rounded-2xl shadow-xl p-6 transform hover:scale-105 transition">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-3xl shadow-xl p-8 border-2 border-gray-200">
                    <h3 class="text-black-600 text-xl font-black mb-6 uppercase tracking-wide">⚽ GOLS MARCADOS</h3>
                ...
                <div class="bg-white rounded-3xl shadow-xl p-8 border-2 border-gray-200">
                    <h3 class="text-yellow-600 text-xl font-black mb-6 uppercase tracking-wide">🛡️ GOLS SOFRIDOS</h3>
                    ...
                    <div class="bg-gray-50 rounded-2xl p-6 flex items-center gap-6 hover:bg-gray-100 transition transform hover:scale-[1.02] border border-gray-200">
                        ...
                        <div class="text-right space-y-2">
                            ...
                            <div class="flex items-center gap-2 justify-end">
                                ...
                                <span class="text-sm font-black text-yellow-600">{{ $scorer['assists'] }}</span>
                            </div>
                            @endif
                        </div>
